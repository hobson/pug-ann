...
__package__ = 'ann'
__doc__ = "{}.{} -- Artificial Neural Netwwork (ANN) utilities by and for the PDX Python User Group (PUG)".format(__parent_package__, __package__)
__url__ = "https://github.com/hobson/{}-{}".format(__parent_package__, __package__)
__version__ = '0.0.1'
